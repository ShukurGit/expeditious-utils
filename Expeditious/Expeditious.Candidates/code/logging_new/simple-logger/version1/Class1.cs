...
namespace Expeditious.Candidates.code.logging_new.SimpleLogger.version1
{
    ...
    public static class Logger
    {
        ...
        public static void Configure(string logDirectory = "logs", LogLevel minLevel = LogLevel.Info, long maxFileSizeBytes = 5 * 1024 * 1024)
        {
