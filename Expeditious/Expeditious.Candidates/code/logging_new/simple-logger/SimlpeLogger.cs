...
namespace Expeditious.Candidates.SimpleLogger_a2
{
    public class SimlpeLogger
    {
        ...
        private static SimpleLoggerOptions _options = new SimpleLoggerOptions();
        ...
        public static void Configure(SimpleLoggerOptions options)
        {
            _options = options ?? new SimpleLoggerOptions();
            Directory.CreateDirectory(_options.LogDirectory);
        }
        ...
        private static string FormatJson(SimpleLogLevel level, string message, Exception ex, object data, bool includeStack)
        {
        ...
        private static string FormatPlain(SimpleLogLevel level, string message, Exception ex, object data, bool includeStack)
        {
        ...
        {
            return Path.Combine(_options.LogDirectory, $"log_{DateTime.UtcNow:yyyy-MM-dd}.txt");
        }
